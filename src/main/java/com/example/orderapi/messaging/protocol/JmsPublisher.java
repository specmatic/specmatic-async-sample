...
@Slf4j
@Component
@ConditionalOnProperty(name = "send.protocol", havingValue = "jms")
public class JmsPublisher implements MessagePublisher {
    ...
    public void publish(String channel, String messagePayload, String correlationId) {
        log.info("Publishing to JMS - Queue: {}, CorrelationId: {}", channel, correlationId);
        ...
        log.debug("Published to JMS successfully");
    }
}
